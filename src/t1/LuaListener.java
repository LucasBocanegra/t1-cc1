...
public interface LuaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LuaParser#prog}.
	 * @param ctx the parse tree
	 */
	void enterProg(LuaParser.ProgContext ctx);
	/**
	 * Exit a parse tree produced by {@link LuaParser#prog}.
	 * @param ctx the parse tree
	 */
	void exitProg(LuaParser.ProgContext ctx);
	/**
